...
public class PanelTimer extends JPanel implements ActionListener
{
  ...
  public PanelTimer ()
  {
    ...
    for(int x=0;x<10;x++)
    {
      images[x]=ImageLoader.imageIcon("/images/numbers/"+x+".png");
    }
    for(int x=0;x<5;x++)
    {
      if(x==2)
      {
        numbers[x]=new JLabel(ImageLoader.imageIcon("/images/numbers/colon.png"));
      }
      else
      {
   ...
   * @param count the number of seconds past
   */
