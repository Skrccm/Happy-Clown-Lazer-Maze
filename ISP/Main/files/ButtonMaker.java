...
class ButtonMaker
{
  ...
  {
    JButton temp = new JButton (ImageLoader.imageIcon("/images/buttons/"+button+"/button.png"));
    if(ImageLoader.imageIcon("/images/buttons/"+button+"/button_rollover.png")!=null)
      temp.setRolloverIcon (ImageLoader.imageIcon ("/images/buttons/"+button+"/button_rollover.png"));
    if(ImageLoader.imageIcon("/images/buttons/"+button+"/button_pressed.png")!=null)
      temp.setPressedIcon(ImageLoader.imageIcon("/images/buttons/"+button+"/button_pressed.png"));
    temp.setBorder (null);
